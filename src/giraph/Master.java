...
public class Master extends DefaultMasterCompute { // master compute
...
registerAggregator(ID, LongSumAggregator.class); 
/*
 * Change to "DoubleSumAggregator.class" for running SGD !!!
 * 
 * */

// this is how we associate
