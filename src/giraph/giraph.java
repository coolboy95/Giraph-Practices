...
public class giraph implements Tool{
	...
	public int run(String[] argss) throws Exception {
		// TODO Auto-generated method stub
		setInputPath("/home/coolboy/g4");
		setOutputPath("/home/coolboy/GiraphOutput/g51");
		...
		giraphConf.setMasterComputeClass(Master.class);
	...
	public static void main(String[] args) throws Exception{
		ToolRunner.run(new giraph(), args);
